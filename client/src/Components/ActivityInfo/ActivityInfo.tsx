...
const SendApplicationForm:FC<ApplicationFormProps> = (props) =>{
    ...
    let isNotSent = appStatus==="activityinfo/APPLICATION_NOT_SENT";
    let isRejected = appStatus === "activityinfo/APPLICATION_REJECTED";
    let isSent = appStatus==="activityinfo/APPLICATION_SENT";
    let isAccepted = appStatus==="activityinfo/APPLICATION_ACCEPTED";

    const onSubmit = (evnt:any) =>{
        evnt.preventDefault();
        switch (appStatus){
            case "activityinfo/APPLICATION_NOT_SENT":
            case  "activityinfo/APPLICATION_REJECTED":
                props.onAppStatusSubmit("activityinfo/APPLICATION_SENT");
                break;
            case "activityinfo/APPLICATION_SENT":
                props.onAppStatusSubmit("activityinfo/APPLICATION_NOT_SENT");
                break;
        }
    } 
    return(
